          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Gemini 2.0</p>
              </div>
            </div>
        ...
        <div className="p-4 bg-white border-t border-gray-200 safe-area-bottom">
          <div className="flex gap-2 items-end">
            <textarea
              ...
              placeholder={language === 'en-IN' ? 'Type message...' : 'संदेश लिखें...'}
            ...
            <button
              ...
              className="p-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {listening && (
            <div className="mt-2 text-xs text-red-500 font-semibold flex items-center gap-2">
              ...
              {language === 'en-IN' ? 'Listening...' : 'सुन रहा हूँ...'}
            </div>
          )}
        </div>
      </div>

      {/* Desktop: Bottom Right Window */}
      <div className="hidden md:block fixed bottom-24 right-6 z-50 w-[420px] h-[600px] bg-white rounded-2xl shadow-2xl flex-col overflow-hidden border border-gray-200 animate-scale-up">
        {/* Desktop Header */}
        <div className="bg-gray-900 text-white p-4 border-b border-gray-800">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
